...
class Myhouses(models.Model):
    ...
    house_image7 = models.ImageField(upload_to='documents/', null=True, blank=True,)
    house_image8 = models.ImageField(upload_to='documents/', null=True, blank=True,)
    house_image9 = models.ImageField(upload_to='documents/', null=True, blank=True,)
    house_image10 = models.ImageField(upload_to='documents/', null=True, blank=True,)
    house_image11 = models.ImageField(upload_to='documents/', null=True, blank=True,)
    house_image12 = models.ImageField(upload_to='documents/', null=True, blank=True,)
